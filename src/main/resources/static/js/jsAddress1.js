var addressInit = function(_cmbProvince1, _cmbCity1, _cmbArea1, defaultProvince, defaultCity, defaultArea)
{
    var cmbProvince1 = document.getElementById(_cmbProvince);
    var cmbCity1 = document.getElementById(_cmbCity);
    var cmbArea1 = document.getElementById(_cmbArea);
    ...
    function changeCity()
    {
        ...
        {
            cmbAddOption(cmbArea1, item.areaList[i], null);
        }
        cmbSelect(cmbArea1, defaultArea);
    }
    function changeProvince()
    {
        ...
        {
            cmbAddOption(cmbCity1, item.cityList[i].name, item.cityList[i]);
        }
        cmbSelect(cmbCity1, defaultCity);
        changeCity();
    ...
    {
        cmbAddOption(cmbProvince1, provinceList[i].name, provinceList[i]);
    }
    cmbSelect(cmbProvince1, defaultProvince);
    changeProvince();
    cmbProvince1.onchange = changeProvince;
}
